...
namespace Cedisur
{
    public partial class AgregarPagos : Form
    {
        ...
        public AgregarPagos() => InitializeComponent();
        ...
        private void BtnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else if (MessageBox.Show("Estas seguro que deseas aplicar este pago?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                ...
                SqlCommand cmd = new("Insert into Pagos(facturaN,importePagoMXP,importePagoUSD, fechaPago, SPEI, numCuenta, numContrato,ID_proveedor,ID_factura,TipoDeCambio) values (@facturaN,@importePagoMXP,@importePagoUSD,@fechaPago, @SPEI,@numCuenta, @numContrato,@ID_proveedor,@ID_factura,@tipoDeCambio)")
                {
