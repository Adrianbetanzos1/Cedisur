...
namespace Cedisur
{
    public partial class VerProveedores : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            else if (MessageBox.Show("Estás seguro que deseas eliminar a este proveedor? Los datos y facturas afiliadas a este también se eliminarán", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                conexion.Open();
